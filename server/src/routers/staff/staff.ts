...
router.get("/", logged(), restaurantWorker({ _id: 1, locations: 1, staff: { userId: 1, settings: { isOwner: 1, work: 1, } }, info: { name: 1, id: 1 }, }, { work: { cook: true }, }, { work: { waiter: true } }), async (req, res) => {
